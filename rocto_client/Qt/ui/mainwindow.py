...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.conn_status = QtWidgets.QLabel(self.get_task)
        self.conn_status.setEnabled(False)
        self.conn_status.setObjectName("conn_status")
        self.gridLayout_2.addWidget(self.conn_status, 0, 2, 1, 1)
        ...
        self.label_5 = QtWidgets.QLabel(self.runBox)
        self.label_5.setObjectName("label_5")
        self.horizontalLayout.addWidget(self.label_5)
        self.number_of_tasks = QtWidgets.QSpinBox(self.runBox)
        ...
        self.get_task_but.setObjectName("get_task_but")
        self.horizontalLayout.addWidget(self.get_task_but)
        self.run_button = QtWidgets.QPushButton(self.runBox)
        ...
        self.gridLayout_2.addWidget(self.runBox, 1, 0, 1, 8)
        ...
        self.gridLayout_4.addWidget(self.select_rocto, 0, 0, 1, 1)
        ...
        self.menuBar.setGeometry(QtCore.QRect(0, 0, 542, 25))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.runBox.setTitle(_translate("MainWindow", "Run settings:"))
        self.label_5.setText(_translate("MainWindow", "Number of tasks:"))
        self.get_task_but.setText(_translate("MainWindow", "Get task!"))
        self.run_button.setText(_translate("MainWindow", "Run!"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.get_task), _translate("MainWindow", "Get Tasks"))
        self.select_rocto.setText(_translate("MainWindow", "Select a .rocto file"))
